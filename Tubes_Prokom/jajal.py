...
class SamsungStoreApp:
    ...
    def pembelian(self,selected_item):
        ...
        window_pembelian.geometry("500x300")
        
        ttk.Label(window_pembelian, text=f"Anda telah memilih {selected_item}!", font=("Arial", 16)).pack(pady=20)

        ttk.Label(window_pembelian, text="Durasi").pack(pady=5)
